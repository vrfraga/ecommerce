...
class Cart extends Model{
    ...
    public function getProducts(){
        ...
        $rows = $sql->select("
            SELECT b.idproduct, b.desproduct, b.vlprice, b.vlwidth, b.vlheight, b.vllenght,b.vlweight,b.desurl COUNT(*) AS nrqtd, 
            SUM(b.vlprice) AS vltotal
            FROM tb_cartsproducts a
            INNER JOIN tb_products b ON a.idproduct = b.idproduct
            WHERE a.idcart = :idcart AND a.dtremoved IS NULL 
            GROUP BY b.idproduct, b.desproduct, b.vlprice, b.vlwidth, b.vlheight, b.vllenght,b.vlweight,b.desurl
    ...
    public function setFreight($nrzipcode){
        ...
        if ($totals['nrqtd'] > 0 ) {
            ...
            $this->stnrdays($result->PrazoEntrega);
