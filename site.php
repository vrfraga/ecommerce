...
$app->post("/checkout" , function(){ 
    ...
    if (!isset($_POST['zipcode']) || $_POST['zipcode'] === '') {
     ...
     if (!isset($_POST['descounry']) || $_POST['descounry'] === '') {
...
$app->post("/register", function(){
    ...
    if (!isset($_POST['email']) || $_POST['email'] == '') {
       ...
       User::setErrorRegister("Preenncha o seu E-mail");
       header("Location /login");
       exit; 
    }
     ...
     if (!isset($_POST['password']) || $_POST['password'] == '') {
       ...
       User::setErrorRegister("Preenncha o sua Senha");
       header("Location /login");
       exit; 
    }
...
$app->post("/profile", function(){ 
    ...
    if ($_POST['desemail'] !== $user->getdesemail()){
        ...
        if (User::checkLoingExists($_POST['desemail']) === true) {              
...
$app->get("/profile/change-password", function(){
    ...
    User::setSucssess("Senha alterada com sucesso");
    header("Location: /profile/change-password");
    exit; 
